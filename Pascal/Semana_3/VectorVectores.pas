...
begin
    p.codigo:=random(10);  //el if que chequea corte de control
    p.genero:=1+random(8);
...
begin
    ...
    begin
        ...
        WriteLn('Promedio: ',l^.dato.puntaje_Promedio);
        l:=l^.sig;
    end;
end;
//___________________________________________________________________________
{procedure ImprimirPeliculas(var v:vector);
var
    i:integer;
begin
